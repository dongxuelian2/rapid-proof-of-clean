...
explains overlap and search limits. Figures are supplied in PNG and SVG.
...
The final technical candidate is v2.2: a 36-frame clean-PASS certificate, early
FLAG exits and a 60-frame diagnostic tail. All benchmark and time numbers remain
